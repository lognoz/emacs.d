...
(defvar php-mode-manual-path "https://www.php.net/manual/en/"
  "The prefix path of php mode manual.")

(defvar php-mode-manual-alist
  '("abs"
    "acos"
    "acosh"
    "addcslashes"
...
;;;###autoload
(defun php-mode-manual ()
  (interactive)
  (ivy-read "PHP manual entry: " php-mode-manual-alist
    :require-match t
    :action
    (lambda (entry)
      (setq function (replace-regexp-in-string "_" "-" entry nil 'literal))
